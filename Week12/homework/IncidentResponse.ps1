...
Set-SCPFile -ComputerName '192.168.4.50' -Credential (Get-Credential matthew.eckhardt@cyber.local) -RemotePath '/home/matthew.eckhardt@cyber.local' -LocalFile "C:\Users\$Env:UserName\results.zip"
